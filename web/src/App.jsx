...
import { fetchCoins, fetchCoin, readLaunchpad, readBalance } from "./lib/client";
  ...
  return (
    <div className="app">
      ...
      <footer className="footer">
        <div>StockPad — launch coins paired with Robinhood Chain Stock Tokens. DYOR. Not financial advice.</div>
        <div className="muted">
          {isDeployed() ? `Launchpad ${shortAddr(CONTRACTS.launchpad)}` : "⚠ Contracts not deployed yet — see src/config/addresses.js"}
        </div>
      </footer>
    </div>
  );
    ...
    <>
      <section className="hero">
        <div className="hero-copy">
          <span className="badge">Robinhood Chain · chainId 4663</span>
          <h1>
            Launch a coin.
            <br />
            Pair it with <span className="accent">NVDA · AAPL · TSLA</span>.
          </h1>
        ...
        <div className="hero-card">
          ...
          <div className="hero-tickers">
            {Object.keys(STOCKS).slice(0, 5).map((t) => (
              <span key={t} className="ticker-chip" style={{ borderColor: STOCKS[t].color }}>
        ...
        <div className="section-grid">
          ...
          <div className="why">
            ...
            <ol className="steps">
              ...
              <li><b>Seed</b> — the contract pairs it with NVDA, AAPL, or any Stock Token you choose.</li>
      ...
      <section className="section">
        ...
        {coins === null ? (
          ...
          <div className="empty">
            <p>No coins yet. Be the first to launch one 👆</p>
          </div>
        ) : (
          <div className="grid">
            {featured.map((c) => (
  ...
  return (
    <section className="section">
      ...
      {coins === null ? (
        ...
        <div className="empty"><p>No coins launched yet.</p></div>
      ) : (
        <div className="grid">
          {coins.map((c) => (
            <CoinCard key={c.id} coin={c} onOpen={(id) => navigate("#/coin/" + id)} />
    ...
    <section className="section">
      ...
      <div className="detail-head">
        <div className="coin-ident big">
          <div className="coin-logo lg" style={{ background: stockColor }}>{symbol.slice(0, 1)}</div>
          <div>
      ...
      <div className="detail-chart">
        <Sparkline address={token} up width={720} height={140} />
      </div>
      ...
      <div className="detail-stats">
        ...
        <div className="dstat"><span className="label">Seeded</span><span className="value">{timeAgo(createdAt)}</span></div>
      </div>
      ...
      <div className="detail-links">
        ...
        <span className="muted">Creator {shortAddr(creator)}</span>
      </div>
